...
class AgentRepository:
    ...
    async def save_memory(
        ...
        Args:
            node_id: The agent that processed the interaction.
...
class MemoryRepository:
    ...
    @staticmethod
    async def get_latest_summary(node_id: str) -> MemorySummaryRecord | None:
        ...
        async with get_session() as session:
            result = await session.execute(
                ...
                .where(MemorySummaryRecord.node_id == node_id)
