...
1. **Handle** — Serialize the execution state, persist a
   :class:`~singularity.memory_vault.models.SyncPromptRecord`, and
...
class InterruptHandler:
    ...
    def set_graph(self, compiled_graph: Any) -> None:
        ...
        Args:
            compiled_graph: The compiled LangGraph state graph returned
                by :func:`~singularity.swarm_orchestration.graph.build_graph`.
        """
    ...
    async def handle_interrupt(
        self,
        interrupt_request: C2InterventionRequest,
        graph_run_id: str,
        thread_id: str,
    ) -> str:
        ...
        Returns:
            ...
            :class:`~singularity.memory_vault.models.ExecutionStateRecord`.
        """
        logger.info(
        ...
        action: ActionProposal = interrupt_request.proposed_action
    ...
    def _emit_interrupt_telemetry(irq: C2InterventionRequest) -> None:
        ...
        frame = DiagnosticFrame(
            node_id=irq.proposed_action.node_id,
