"""Tests for the SimulatedCognitionModel and agent registry."""
...
class TestSimulatedChatModel:
    ...
    async def test_security_threat_keyword(self) -> None:
        ...
        model = SimulatedCognitionModel(node_role="security", response_delay=0)
    ...
    async def test_core_agent_routing(self) -> None:
        ...
        model = SimulatedCognitionModel(node_role="core", response_delay=0)
    ...
    async def test_environment_health(self) -> None:
        ...
        model = SimulatedCognitionModel(node_role="environment", response_delay=0)
    ...
    async def test_memory_store(self) -> None:
        ...
        model = SimulatedCognitionModel(node_role="memory", response_delay=0)
    ...
    async def test_coding_generate(self) -> None:
        ...
        model = SimulatedCognitionModel(node_role="coding", response_delay=0)
    ...
    async def test_analytical_anomaly(self) -> None:
        ...
        model = SimulatedCognitionModel(node_role="analytical", response_delay=0)
    ...
    async def test_creative_brainstorm(self) -> None:
        ...
        model = SimulatedCognitionModel(node_role="creative", response_delay=0)
    ...
    async def test_unknown_role_fallback(self) -> None:
        ...
        model = SimulatedCognitionModel(node_role="unknown_role", response_delay=0)
    ...
    def test_repr(self) -> None:
        ...
        model = SimulatedCognitionModel(node_role="security", response_delay=0.1)
...
class TestAgentRegistry:
    ...
    def test_register_agent_decorator(self, mock_agent) -> None:
        """@register_node should add class to the registry."""
    ...
    def test_duplicate_registration_raises(self) -> None:
        """Registering the same NODE_ID twice should raise ValueError."""
        from tests.conftest import MockNode
    ...
    def test_missing_agent_id_raises(self) -> None:
        """Agent class without NODE_ID should raise ValueError."""
    ...
    def test_get_agent_by_id(self) -> None:
        """get_node should return the correct instance."""
        from tests.conftest import MockNode

        register_node(MockNode)
        initialize_constellation()
        agent = get_node("mock-001")
        assert agent.node_name == "MockNode"

    def test_get_agent_not_found(self) -> None:
        """get_node should raise KeyError for unknown ID."""
        with pytest.raises(KeyError, match="nonexistent"):
            get_node("nonexistent")

    def test_get_all_agents_ordered(self) -> None:
        """get_all_nodes should return agents ordered by priority."""
        from tests.conftest import MockNode
        ...
        register_node(HighPriorityNode)
        register_node(LowPriorityNode)
        initialize_constellation()
    ...
    def test_reset_registry(self) -> None:
        ...
        register_node(MockNode)
        initialize_constellation()
        assert len(get_all_nodes()) == 1

        reset_registry()
        assert len(get_registered_classes()) == 0
        assert len(get_all_nodes()) == 0
