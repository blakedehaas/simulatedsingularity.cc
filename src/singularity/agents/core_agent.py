...
@register_agent
class CoreAgent(AsyncBaseAgent):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        logger.info("CoreAgent initialized — priority 1")
    ...
    async def handle_prompt(self, payload: PromptPayload) -> AgentResponse:
        ...
        Returns:
            An :class:`AgentResponse` — either from the delegated agent
    ...
    async def emit_telemetry(self) -> TelemetryFrame:
        ...
        Returns:
            A :class:`TelemetryFrame` with routing and delegation counts.
        """
